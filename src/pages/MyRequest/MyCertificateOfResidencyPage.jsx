      ...
      {loading ? (
        ...
        <>
          {residency.length === 0 ? (
            ...
            <>
              <FormDataTable data={currentItems} category="certificate-of-residency"/>
...
export default MyCertificateOfResidencyPage;
