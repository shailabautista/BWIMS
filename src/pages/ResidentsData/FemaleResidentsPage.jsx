...
const FemaleResidentsPage = () => {
  ...
  const filteredData = userData
    ...
    .filter((entry) => {
      ...
      const isFemale = entry.sex === "Female";

      return includesSearchTerm && isBarangayMatch && isFemale && entry.isVerified;
    });
...
export default FemaleResidentsPage;
